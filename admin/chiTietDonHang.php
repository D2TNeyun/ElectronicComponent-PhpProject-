...
<div class="col-sm-9 mx-3 jumbotron">
    ...
    <div class="col-sm-5" style="display: inline-block;">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nm_sdt" name="nm_sdt" value="<?php if(isset($row['dh_pttt'])) { if ( $row['dh_pttt'] == 2) {echo "Thanh toan online"; } else {echo "Thanh toan offline"; }  } ?>" readonly>
        </div>
    </div>
